...
describe("scroll ownership contracts", () => {
  it("keeps 41 uniquely named modules and the same registered module objects", () => {
    expect(scrollContracts).toHaveLength(41);
    expect(new Set(scrollContracts.map(entry => entry.name)).size).toBe(41);
