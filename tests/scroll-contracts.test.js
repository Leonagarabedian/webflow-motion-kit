...
describe("scroll ownership contracts", () => {
  it("keeps 39 uniquely named modules and the same registered module objects", () => {
    expect(scrollContracts).toHaveLength(39);
    expect(new Set(scrollContracts.map(entry => entry.name)).size).toBe(39);
