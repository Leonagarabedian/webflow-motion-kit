...
describe('stationary typography behavior and migration',()=>{
  ...
  it('reveals plush-bloom from the center and defers heavy per-glyph rendering',()=>{
    ...
    expect(plush.querySelectorAll('[data-plush-glyph]').length).toBeGreaterThan(0);
    expect(plush.querySelectorAll('[data-plush-canvas]').length).toBe(0);
    cleanup();
  });
