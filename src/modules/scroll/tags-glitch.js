import { resolveScrollContract, relativeSpan, measuredRunway } from "../../core/scroll-alignment/contract.js";
...
function ensureStyles(doc) {
  ...
  style.id = STYLE_ID;
  style.textContent = `
    [data-mk-tags-glitch-section] { position: relative !important; min-height: var(--mk-tags-glitch-height, 200vh) !important; overflow: clip !important; isolation: isolate; }
    [data-mk-tags-glitch-stage] { position: sticky; top: 0; width: 100%; height: 100svh; overflow: clip; }
    [data-mk-tags-glitch-field] { position: absolute !important; inset: 0 !important; z-index: 1; }
    [data-mk-tags-glitch-cluster] { position: absolute !important; left: var(--mk-cluster-x) !important; top: var(--mk-cluster-y) !important; transform: translate(-50%, -50%); }
    [data-mk-tags-glitch-title] { position: absolute !important; z-index: 2; top: 50% !important; left: 50% !important; transform: translate(-50%, -50%); pointer-events: none; will-change: transform; }
  ...
  mount(section, { gsap, ScrollTrigger, reducedMotion }) {
    ...
    if (!reducedMotion()) {
      ...
      timeline = gsap.timeline({
        defaults: { ease: "none" },
        scrollTrigger: resolveScrollContract(section, {
        ...
        }, () => ({ start: "top top", end: () => relativeSpan(measuredRunway(section)) }))
      });
