import { resolveScrollContract, relativeSpan, layoutSize } from "../../core/scroll-alignment/contract.js";
...
export const liquidFill = {
  ...
  mount(element, { gsap, ScrollTrigger, reducedMotion }) {
    ...
    const scrollTriggerConfig = resolveScrollContract(element, buildDynamicSpanTrigger({
      ...
      start: "top top",
      end: endTrigger ? "bottom bottom" : () => relativeSpan(layoutSize(container).height)
    }));
