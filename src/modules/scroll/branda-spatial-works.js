import { resolveScrollContract, relativeSpan } from "../../core/scroll-alignment/contract.js";
  ...
  mount(root, { gsap, ScrollTrigger, reducedMotion }) {
    ...
    (async () => {
      try {
        ...
        scrollTrigger = ScrollTrigger.create(resolveScrollContract(root, {
        ...
        }, () => ({ start: "top top", end: () => relativeSpan(getScrollDistance()) })));
