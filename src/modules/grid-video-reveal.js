...
function encodeMask(cols, rows, cells, gap) {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${cols} ${rows}" preserveAspectRatio="none" shape-rendering="crispEdges"><rect width="100%" height="100%" fill="black"/>${rects}</svg>`;
